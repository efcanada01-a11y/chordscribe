...
# Use tiny model for better stability on Railway
...
def transcribe():
    ...
    try:
        ...
        lyrics = "\n".join(lyrics_list) if lyrics_list else "No clear vocals detected in this audio."
...
def generate_pdf(pdf_path, song_name, lyrics):
    ...
    c.drawString(50, height - 150, "Generated by Chordscribe • Real AI Transcription")
    ...
    for line in lines:
        ...
        c.setFont("Helvetica", 12)
        wrapped_lines = simpleSplit(line.strip(), "Helvetica", 12, 450)
